/interface wireguard add listen-port=13231 mtu=1420 name=wg-workshop private-key="II4Y8dEk+zZjFLbjHR40vIhBKs9QB2+YEpBcxdaNt0w="
/interface bridge add name=bridge-eoip
/interface eoip add name=eoip-workshot remote-address=10.20.1.1 tunnel-id=19
/ip pool add name=local_19 ranges=10.10.19.2-10.10.19.14
/ip dhcp-server add address-pool=local_19 interface=bridge name=dhcp_19
...
/ip address add address=10.20.1.19/24 interface=wg-workshop network=10.20.1.0
/ip address add address=10.10.19.1/28 interface=bridge network=10.10.19.0
/ip dhcp-server network add address=10.10.19.0/28 dns-server=10.20.1.1 gateway=10.10.19.1
/ip firewall mangle add action=mark-routing chain=prerouting new-routing-mark=wg disabled=yes comment="route every traffic into the tunnel" passthrough=yes src-address=10.10.19.0/28
/ip firewall address-list add address=10.10.19.0/28 list=LOCAL19
...
/system identity set name="WG_ID 19"
