/interface wireguard add listen-port=13231 mtu=1420 name=wg-workshop private-key="iE/WeGsBfN4T3E4rpNBQ7W3GJqJ0iup2PYBMLve7z1o="
/interface bridge add name=bridge-eoip
/interface eoip add name=eoip-workshot remote-address=10.20.1.1 tunnel-id=13
/ip pool add name=local_13 ranges=10.10.13.2-10.10.13.14
/ip dhcp-server add address-pool=local_13 interface=bridge name=dhcp_13
...
/ip address add address=10.20.1.13/24 interface=wg-workshop network=10.20.1.0
/ip address add address=10.10.13.1/28 interface=bridge network=10.10.13.0
/ip dhcp-server network add address=10.10.13.0/28 dns-server=10.20.1.1 gateway=10.10.13.1
/ip firewall mangle add action=mark-routing chain=prerouting new-routing-mark=wg disabled=yes comment="route every traffic into the tunnel" passthrough=yes src-address=10.10.13.0/28
/ip firewall address-list add address=10.10.13.0/28 list=LOCAL13
...
/system identity set name="WG_ID 13"
