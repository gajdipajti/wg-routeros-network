/interface wireguard add listen-port=13231 mtu=1420 name=wg-workshop private-key="GNqo8FdePxX5ey09BBSb8S+P5vtH5rpBvDFzP6nt3Hg="
...
/ip dhcp-server add address-pool=local_18 interface=bridge name=dhcp_18
...
/ip address add address=10.20.1.18/24 interface=wg-workshop network=10.20.1.0
/ip address add address=10.10.18.1/28 interface=bridge network=10.10.18.0
/ip dhcp-server network add address=10.10.18.0/28 dns-server=10.20.1.1 gateway=10.10.18.1
/ip firewall mangle add action=mark-routing chain=prerouting new-routing-mark=wg disabled=yes comment="route every traffic into the tunnel" passthrough=yes src-address=10.10.18.0/28
/ip firewall address-list add address=10.10.18.0/28 list=LOCAL18
